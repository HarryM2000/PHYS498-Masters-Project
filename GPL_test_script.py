...
priors['p'] = Uniform(1.5, 2.99, 'p', latex_label=r'$\p$')
...
priors['kappa_1'] = Uniform(0.1, 20, 'kappa_1', latex_label=r'$\kappa_1$')
priors['mej_2'] = Uniform(0.005, 0.015, 'mej_2', latex_label=r'$\mej_2$')
priors['vej_2'] = Uniform(0.01, 0.2, 'vej_2', latex_label=r'$\vej_2$')
priors['temperature_floor_2'] = LogUniform(1500, 3500, 'temperature_floor_2', latex_label=r'$\temperature_floor_2$')
priors['kappa_2'] = Uniform(0.1, 2, 'kappa_2', latex_label=r'$\kappa_2$')
priors['xiN'] = Uniform(0.01, 1.0, 'xiN', latex_label=r'$\xiN$')
